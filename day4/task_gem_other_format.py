...
if system_input==user_input:
    print("Tie")
      ...
      or system_input=='SCISSORS' and user_input=='ROCK'
      or system_input=='PAPER' and user_input=='SCISSORS') :
    print("USER WIN")
elif (system_input=='ROCK' and user_input=='SCISSORS'
      or system_input=='SCISSORS' and user_input=='PAPER'
      or system_input=='PAPER' and user_input=='ROCK'):
    print('SYSTEM WIN')
else:
